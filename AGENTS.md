...
This project is indexed by GitNexus as **EasyAccounting** (6808 symbols, 13228 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
