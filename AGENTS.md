...
This project is indexed by GitNexus as **EasyAccounting** (4681 symbols, 10105 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
