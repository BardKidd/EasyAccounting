...
export function Hero() {
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
      ...
      <div className="container relative z-10 mx-auto px-6 md:px-12">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-12">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm text-xs font-medium tracking-widest uppercase text-slate-500 dark:text-slate-400">
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-6 duration-1000 ease-out delay-100">
            ...
            <p className="font-serif text-xl md:text-2xl text-slate-600 dark:text-slate-300 tracking-[0.15em] leading-relaxed">
              專業個人記帳應用
            </p>
          </div>

          {/* Description - Clean Sans */}
          <p className="max-w-xl mx-auto text-base md:text-lg text-slate-500 dark:text-slate-400 leading-8 font-light animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 ease-out delay-300">
            <Link href="/dashboard">
              <Button
                size="lg"
                className="h-14 px-10 rounded-sm bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-200 text-base tracking-widest uppercase font-medium shadow-xl shadow-slate-200/50 dark:shadow-none transition-all hover:scale-105"
              >
                開始使用
              </Button>
            </Link>
            <Link href="#features">
              <Button
                variant="outline"
                size="lg"
                className="group h-14 px-10 rounded-sm border-slate-300 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-900 text-base tracking-widest uppercase font-medium hover:border-slate-400 transition-all"
              >
                了解更多
