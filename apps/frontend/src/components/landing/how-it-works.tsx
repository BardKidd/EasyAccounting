export function HowItWorks() {
  ...
  return (
    <section className="py-32 bg-slate-50 dark:bg-slate-950 transition-colors duration-500 border-t border-slate-200 dark:border-slate-800">
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center mb-24">
          ...
          <p className="text-slate-600 dark:text-slate-300 md:text-lg max-w-2xl mx-auto font-light leading-relaxed tracking-wide">
          ...
          {steps.map((step) => (
            ...
            >
              <div className="relative mb-8">
                <div className="w-24 h-24 flex items-center justify-center bg-white dark:bg-slate-900 rounded-full border border-slate-100 dark:border-slate-800 shadow-sm group-hover:border-amber-200 dark:group-hover:border-amber-900/50 transition-colors duration-500 z-10">
              ...
              <p className="text-slate-500 dark:text-slate-400 max-w-xs font-light leading-7 text-sm">
                {step.description}
              </p>
            </div>
          ))}
