...
export function Footer() {
  ...
  return (
    <footer className="py-16 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-900 transition-colors duration-500">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-sm leading-7 font-light text-sm">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-slate-100 dark:border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-light text-slate-400 dark:text-slate-600">
